...
The figures are best seen in
the PDF file of this document.
...
which are technically a subset of Bit~1
(see Table~\ref{t:subtractor1}).
%
%
We omit their discussion to focus on Bit~1.
