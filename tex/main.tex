...
to repress phlG.
} \hh{For the purpose of the experiment, protein PhlF is used as the transcription factor responsive to DAPG and the corresponding promoter PhlF. For intercellular synthesis of DAPG, gene cluster PhlABCD is used as in \cite[Fig. 2a]{DuETAL2020}.}
...
Our simulations have helped identify some issues
but are highly stylized.
%
%
For example,
in reality,
