...
\ra{
In the interest of experimental feasibility and debugging
...
the number of intercellular channels we need.
}
...
and analogously for the other signals.
}
%
%
\ra{
...
\subsection{Extracellular signaling}


The two signals \ce{w_A} and \ce{w_B}
are encoded by 
