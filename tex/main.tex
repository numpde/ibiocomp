...
\hh{luxR & lasR\cite[Table.1]{Fuqua1996},  rpaR\cite[p.2598]{HirakawaETAL2011}, bjaR \cite{Lindemann2011}. (Most -HSL receiver proteins are dimer If the signals have similar structure then so should the protein)}
...
As in 
\cite[\href{https://www.nature.com/articles/nature23271/figures/2}{Fig.~2e}]{GreenETAL2017},
let inputs A/B produce short RNAs \ce{R_A}/\ce{R_B}
that combine to a trigger RNA.
%
%
Additionally,
let 
input B produce 
let 
$\ce{R_A} \rep \ce{RBS_a} \act \ce{R^*_B} \rep \ce{R_B}$,
and vice versa,
i.e.~\ce{R_A} occludes the RBS

that otherwise produces
%
%
\TODO{finish}
