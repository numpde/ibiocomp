...
Methylenomycin is an antibioitic produced 
...
%
\hh{
The TetR homolog protein MmfR is a homodimer \cite{Zhou2020}, 
which contains two Mmf recognition sites,
while different R-groups may alter the binding affinity \cite[p.2-3]{Zhou2020}. 
%
...
\begin{figure}
    ...
    \TODO{provide \emph{specific} reference for each, incl figure number}
\end{figure}
...
\begin{figure}
    ...
    \TODO{provide \emph{specific} reference, incl figure number}
\end{figure}
