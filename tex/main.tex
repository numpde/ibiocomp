...
\begin{figure}
    ...
    \subcaptionbox{%
        Switch OFF RBS. 
        \ra{The unstable hairpin structure is sealed by the trigger RNA, repressing translation}.
        %
    ...
    \subcaptionbox{%
        Switch ON RBS.
        \ra{The stem of the stable hairpin structure is opened by trigger RNA, 
