...
%
\hh{It is suggested that insulators reduce downstream DNA expression dependence in bacterial promoters, particularly the use of non-constitutive promoters such as \promoter{BAD} and \promoter{Tet} \cite{Carr2017}.}
...
%
%
\hh{Of note, insulators are placed between the junction downstream of the non-constitutive promoter and the switch RBS to reduce the interference. See \S\ref{ss:insulation_RBS}
for details. }
%
...
\TODO{do we need Figure \ref{f:switch_on_RBS}}

\TODO{no Insulator in co-trigger RNA AND gate?}
