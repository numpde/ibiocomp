...
We refer to the stabilization of RBS-occluding stemloop as switch-OFF RBS regulation (cf. Figure \ref{f:switch_off_RBS})
}
...
\begin{figure}
    ...
    \begin{subfigure}{\linewidth}
        ...
        \caption{%
            ...
            the trigger RNA, repressing translation. The design is based on the 3-way-junction repressor \cite{Kim2019}.}
        }
    ...
    \caption{%
        Switch-OFF RBS (\ref{f:switch_off_RBS}),
        Switch-ON RBS (\ref{f:switch_on_RBS})
        and 
...
\begin{figure}
    \centering
    \includegraphics[height=0.9\textheight]{xor_ribocomputing/plot-3.pdf}
...
%
This can be sufficient to produce \ce{Xis}
and 
to cause an unintended \emph{reset}.
%
