...
using 
the ``three-way junction'' mechanism
of \citet{Kim2019};
3)~%
a co-trigger RNA:
upon all 3 signals,
...
by a trigger RNA
as ``Switch-ON RBS'',
\ra{see Fig.~\ref{f:switch_on_RBS}/\ref{f:3_RNA_on_RBS}}.
%
%
%
%
...
can \emph{seal} the hairpin
to deactivate translation.
%
We refer to 
this stabilization of RBS-occluding stemloop as ``Switch-OFF RBS''
see Fig.~\ref{f:switch_off_RBS}.
...
shows the genetic circuits implementing our 3-\XOR gate.
%
The first circuit provides the transcription factors
for the signals \ce{s_1} (pC-HSL), \ce{r_1} (IV-HSL) and \ce{c_1} (Sal).
}
