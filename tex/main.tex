...
\TODO{do we need Table~\ref{t:substeps}}
...
\TODO{list all TF used, no details for now}

\TODO{hammerheads of \cite{LouETAL2012}}
...
on \ce{w_B} also
--
but this requires \ce{w_B} to go down early
and requires 
