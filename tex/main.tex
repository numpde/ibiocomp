...
%
Yet,
\citet[Fig.~3c]{DuETAL2020} observed
only weak induction of \promoter{PhlF} by \signal{Sal}.
%
%
CHA0 also contains the gene phlG 
...
\TODO{\hh{it seems this switch-OFF thing is not used in the enhanced AND gate? Should we put it in the XOR?} \ra{moved here. please revise all:}}
