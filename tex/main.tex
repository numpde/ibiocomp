...
%
This reduces 
the required number of transcription factors,
\ra{
e.g.~the Player can use $\protein{FdeR} \to \promoter{FdeA}$
because 
it does not receive the medium of 
Bit~2 that emits \signal{NG}.
}
%
...
The Matlab/SymBiology
codes are available via the same link.
%
Sharp figures in the PDF file.
...
thus we replaced its output 
by
the transcription factor \TODO{act TF}
...
and implemented 
the remainder of it using ribocomputing
\TODO{explain}.
%
%
%
For \ce{c_2}, we implemented
