...
%
%
\TODO{\ce{\#w_A} convention for the number of molecules}
...
\TODO{describe refinement from Bit1-c2-symbio}
...
\begin{figure}[hpbt]
	...
	\caption{%
		...
		similarly to Fig.~\ref{f:symbio-d1-tempo}.
		%
		The logarithmic colorbar goes from $10^{-3}$-or-less (white) to $10^1$ (black).
	}
	%
