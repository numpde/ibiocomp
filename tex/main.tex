...
%
%
We used $\mathsf{0x0E}$ for \ce{r_0},
...
\begin{figure}[hpbt]
	\begin{tabular}{cc|cc}
		...
		\\
		%
		\includegraphics[width=0.22\textwidth]{Bit1/output/response_d1_final__c1_in=0.1}
		&
		\includegraphics[width=0.22\textwidth]{Bit1/output/response_d1_final__c1_in=10}
		&
